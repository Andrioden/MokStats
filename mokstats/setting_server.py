...
PROJECT_DIR = "/srv/www/mokstats/"
SITE_NAME = "mokstats" #The sites unique prepended url, like www.domain.org/SITE_NAME
...
ADMIN_MEDIA_PREFIX = '/%s/static/admin' % SITE_NAME
